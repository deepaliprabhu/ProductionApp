...
-(void)initItem
{
    ...
    UIImageView *imgBgView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, screenRect.size.width, screenRect.size.height)];
    [imgBgView setImage:[UIImage imageNamed:@"background_loading.png"]];
    [self addSubview:imgBgView];
    imgBgView.center = CGPointMake(screenRect.size.width/2, screenRect.size.height/2);
